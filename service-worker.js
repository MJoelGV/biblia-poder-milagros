...
const CACHE_NAME = 'biblia-app-cache-v5';

// Cache estático para recursos principales
const STATIC_CACHE = 'biblia-static-v5';
// Cache dinámico para contenido generado
const DYNAMIC_CACHE = 'biblia-dynamic-v5';
// Cache para datos bíblicos
const DATA_CACHE = 'biblia-data-v5';
...
const AUDIO_SAMPLE_URLS = [
  ...
  '/audio/genesis_02.mp3',
  '/audio/john_01.mp3',
  '/audio/john_03.mp3',
  '/audio/psalm_23.mp3',
  '/audio/proverbs_01.mp3',
  '/audio/matt_05.mp3',
  '/audio/isaiah_53.mp3'
];
...
const ADDITIONAL_URLS = [
  ...
  '/temas.html',
  '/topics.html',
  '/30-dias-con-jesus.html',
  '/planes-estudio.html',
  '/pericopas-standalone.html',
  '/logo-blanco.png',
  '/LOGO BLANCO.png',
  '/headings.json'
];
